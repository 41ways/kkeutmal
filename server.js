...
const { rooms, handle, disconnect, sweepRooms, selfCheck, loadDict } = require('./game');
...
loadDict(fs.readFileSync(path.join(__dirname, 'dict', 'words.txt'), 'utf8'));

server.listen(PORT, () => {
  selfCheck();
  console.log(`끝말잇기 서버 → http://localhost:${PORT}`);
});
